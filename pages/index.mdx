...
Preview the final demo application [here](https://video-sharing.pages.dev/).

Get the complete code for this project [here](https://github.com/fauna-labs/video-sharing).
